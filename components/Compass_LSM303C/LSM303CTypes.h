...
typedef enum {
	MAG_TEMP_EN_DISABLE = 0x00, MAG_TEMP_EN_ENABLE = 0x80
} MAG_TEMP_EN_t;

typedef enum {
	MAG_XYZDA_NO = 0x00, MAG_XYZDA_YES = 0x08
} MAG_XYZDA_t;

typedef enum {
	ACC_I2C_ADDR = 0x1D, //0x1D,
	MAG_I2C_ADDR = 0x1E //0x1E
} I2C_ADDR_t;
...
typedef enum {
	MAG_BDU_DISABLE = 0x00, MAG_BDU_ENABLE = 0x40
} MAG_BDU_t;
...
typedef enum {
	ACC_FS_2g = 0x00, ACC_FS_4g = 0x20, ACC_FS_8g = 0x30
} ACC_FS_t;

typedef enum {
	ACC_BDU_DISABLE = 0x00, ACC_BDU_ENABLE = 0x08
} ACC_BDU_t;
