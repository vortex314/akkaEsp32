...
CXXFLAGS +=  -DWIFI_SSID=${SSID} -DWIFI_PASS=${PSWD} -DESP32_IDF=1 -I../Common -I../microAkka -I$(WORKSPACE)/ArduinoJson -fno-exceptions -fno-rtti -ffunction-sections -fdata-sections 
